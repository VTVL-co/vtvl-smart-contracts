...
interface VariableSupplyERC20TokenInterface extends ethers.utils.Interface {
  functions: {
...
export class VariableSupplyERC20Token extends BaseContract {
  ...
  interface: VariableSupplyERC20TokenInterface;
  ...
  functions: {
    ...
    burntSupply(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    burntSupply(overrides?: CallOverrides): Promise<PopulatedTransaction>;
